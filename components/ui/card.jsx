...
function Card() {
  return (
    <div className="container p-4 mx-auto  flex flex-col sm:flex-row items-center justify-center min-h-screen p-4">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 ">
        <div className="bg-white shadow-lg p-4 border border-gray-200 rounded-3xl max-w-xs h-full hover:shadow-lg hover:scale-110 transition duration-300 ease-out overflow-hidden">
          ...
          <div className="flex justify-start mb-4">
            <hr className="w-1/2 border-none h-1 bg-green-600" />
          </div>
        ...
        <div className="bg-white shadow-lg p-4 border border-gray-200 rounded-3xl max-w-xs h-full hover:shadow-lg hover:scale-110 transition duration-300 ease-out overflow-hidden">
          ...
          <div className="flex justify-start mb-4">
            <hr className="w-1/2 border-none h-1 bg-blue-600" />
          </div>
        ...
        <div className="bg-white shadow-lg p-4 border border-gray-200 rounded-3xl max-w-xs h-full hover:shadow-lg hover:scale-110 transition duration-300 ease-out overflow-hidden">
          ...
          <h2 className="text-green-500 mt-4 text-2xl flex items-center mx-4">
          ...
          <div className="flex justify-start mb-4 ml-auto">
            <hr className="w-1/2 border-none h-1 bg-purple-600" />
          </div>
