    ...
    <div className="flex flex-col min-h-[100dvh]">
        ...
        <section className="py-16 md:py-24 lg:py-32">
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-card p-6 bg-gray-200 rounded-lg shadow-md">
                <div className="flex items-center ml-32 rounded-full justify-center pt-2  h-14 w-14  border-black border-2 bg-white  mb-6">
              ...
              <div className="bg-card p-6 rounded-lg bg-gray-200 shadow-md">
                <div className="flex items-center ml-32 rounded-full justify-center pt-4 h-14 w-14  border-black border-2 bg-white  mb-6">
              ...
              <div className="bg-card bg-gray-200 p-6 rounded-lg shadow-md">
                <div className=" flex items-center ml-32 rounded-full justify-center pt-4  h-14 w-14   border-black border-2 bg-white  mb-6">
        ...
        <section className="bg-muted py-16 md:py-24 lg:py-32">
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-card p-6 rounded-lg shadow-gray-400 shadow-lg">
          ...
          <div className="grid md:grid-cols-2 gap-24 items-center">
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-12">
                <div className="bg-card p-6 max-w-lg min-h-64 rounded-lg shadow-gray-400 shadow-lg">
                ...
                <div className="bg-card p-6 rounded-lg shadow-gray-400 shadow-lg max-w-lg min-h-64">
            ...
            <img
              ...
              height={400}
              alt="About Image"
              className="rounded-lg shadow-gray-400 shadow-lg "
            />
          </div>
        </div>
      </section>
      <section className="py-16 md:py-24 lg:py-32">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-card bg-gray-200 p-6 rounded-lg shadow-md">
              <div className="border-2 border-black bg-white mb-4  rounded-full ml-32 h-14 w-14">
                <CodeIcon className="h-12 w-12 ml-18 text-primary mb-4" />
              </div>
            ...
            <div className="bg-card bg-gray-200 p-6 rounded-lg shadow-md">
              <div className="flex ml-32 items-center rounded-full justify-center pt-4 h-14 w-14  border-black border-2 bg-white  mb-6">
            ...
            <div className="bg-card bg-gray-200 p-6 rounded-lg shadow-md">
              <div className="flex items-center bg-white ml-32 rounded-full justify-center pt-4 h-14 w-14  border-black border-2  mb-6">
