...
export default function DigitalSkills() {
  return (
    <div class="flex flex-col items-center container px-4 mx-auto sm:text-xs md:text-sm lg:text-md">
      <h1 className="text-xl md:text-2xl lg:text-2xl font-bold text-green-800 mt-10 mb-6 text-center shadow-lg shadow-black/30 bg-gray-100 py-4 px-6 rounded-lg">
        Digital Skills Training
      </h1>

      <div class=" max-w-2xl ml-4 flex-1 ">
        <p className="text-lg md:text-lg lg:text-lg leading-7 mb-4">
        ...
        <div className="flex w-full justify-center items-center">
          <button className="W-15 mt-8 px-8 py-3 text-md bg-green-950 font-semibold border-2 border-none p-6 text-white rounded  hover:bg-orange-600 focus:ring-opacity-60 transition duration-300 ">
            <Link href="/course-registration">Register </Link>
          </button>
        </div>
        <h2 className="font-mono text-green-700 font-bold my-4 mt-4 text-xl md:text-2xl lg:text-2xl">
          📋 Program Structure:
        </h2>
        <p className="text-lg md:text-lg lg:text-lg leading-7">
        ...
        <ul className="px-4 py-2 list-disc text-gray-900 text-lg md:text-lg lg:text-lg ">
          <li>
            <span className=" font-bold text-md ">Month 1:</span> Foundational
            Skills (Weeks 1-4)
          </li>
          <li>
            <span className=" font-bold text-md">Month 2:</span> Specialization
            Tracks (Weeks 5-8)
          </li>
          <li>
            <span className="font-bold text-md "> Month 3:</span> Project &
            Portfolio Development (Weeks 9-12)
          </li>
        </ul>

        <h2 className="font-mono font-bold my-2 text-xl md:text-xl lg:text-xl flex  text-green-950">
          <div className="flex">
            {""}
            <span className="ml-2"> 📅 Weekly Breakdown:</span>
          </div>
        </h2>
        <ul className="px-6 py-2 list-checked text-lg md:text-lg lg:text-lg   leading-7">
          <li className="pb-4 ">
            {" "}
            <span className="font-bold text-lg md:text-xl lg:text-xl  inline-block align-middle">
              🛠️ Workshops:
            </span>{" "}
          ...
          <li className="pb-4">
            <span className="font-bold text-lg md:text-xl lg:text-xl">
              💬 Group Discussions:
            </span>{" "}
        ...
        <ul className="px-6  text-lg leading-7 ">
          <li className="pb-4">
            {" "}
            <span className="font-bold text-lg md:text-xl lg:text-xl">
          ...
          <li className="pb-4">
            ...
            A detailed breakdown of the weekly activities and learning
        ...
        <h2 className="font-mono font-bold my-4 boder-l-4 border-green-800 p-1 bg-green-100   text-lg lg:text-xl md:text-xl">
          <span className=" rounded-md p-2 mb-2">Month 1:</span> Foundational
          Digital Skills
        </h2>
        <p className="text-lg md:text-lg lg:text-lg leading-7">
        ...
        <h2 className="font-mono font-bold my-4 border-l-4 border-orange-600 p-1 bg-orange-100 text-lg lg:text-xl md:text-xl">
          {" "}
          <span className=" rounded-md p-2">Week 1-2:</span> Microsoft Office
          and Google Suite
        </h2>
        <ul className="py-4 list-disc text-lg md:text-lg lg:text-lg  ml-6 ">
          <li>
        ...
        <h2 className="font-mono font-bold border-l-4 border-orange-600 p-1 bg-orange-100 my-4 left-6 text-lg lg:text-xl md:text-xl">
          <span className=" rounded-md p-2 ">Week 3-4:</span> Google Suite and
        ...
        <h2 className="font-mono font-bold boder-l-4 border-green-800 p-1 bg-green-100 my-4 text-lg lg:text-xl md:text-xl">
          <span className=" rounded-md p-2">Month 2:</span> Specialization
          Tracks (Weeks 5-8)
        </h2>
        <p className="text-lg">
        ...
        <h2 className="font-mono font-bold text-orange-600 my-4 text-lg lg:text-xl md:text-xl">
          📊 Track A: Data Analysis
        </h2>
        <ul className="py-4 list-disc text-lg lg:text-lg md:text-lg ml-6">
          <li>
        ...
        <h2 className="font-mono text-orange-600 font-bold text-lg lg:text-xl md:text-xl my-4 ">
        ...
        <h2 className="font-mono font-bold my-6 text-orange-600 text-lg lg:text-xl md:text-xl">
          💻 Track C: Coding Fundamentals
        </h2>
        <ul className="py-4 ml-6 list-disc text-lg md:text-lg lg:text-lg">
          <li>
        ...
        <h2 className="font-mono font-bold my-6 boder-l-4 border-green-800 p-1 bg-green-100 text-lg lg:text-xl md:text-xl">
          <span className=" ">Month 3:</span> Project & Portfolio Development
          (Weeks 9-12)
        </h2>
        <h2 className="font-mono font-bold border-l-4 border-orange-600 p-1 bg-orange-100 my-4 text-lg lg:text-xl md:text-xl">
          <span className=" rounded-md p-1 ">Week 9:</span> Project Selection &
          Planning:
        </h2>
        <ul className="py-6 list-disc text-lg lg:text-lg md:text-lg  ml-6">
        ...
        <h2 className="font-mono font-bold border-l-4 border-orange-600 p-1 bg-orange-100 my-2 text-lg lg:text-xl md:text-xl">
          <span className=" rounded-md p-1 ">Week 10-11:</span> Project
          Development
        </h2>
        <ul className="py-4 list-disc text-lg md:text-lg lg:text-lg ml-6">
        ...
        <h2 className="font-mono font-bold border-l-4 border-orange-600 p-1 bg-orange-100 my-4 text-lg lg:text-xl md:text-xl">
          <span className=" rounded-md p-1 ">Week 12:</span> Portfolio Building
          & Career Preparation:
        </h2>

        <ul className="py-6 list-disc text-lg md:text-lg lg:text-lg ml-6">
          <li>
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg mb-6 border border-gray-200">
          <ul className="py-4 list-none ml-6 text-lg lg:text-xl md:text-xl">
            <li className="flex items-start mb-3">
              ✅ Gain practical skills and hands-on experience in digital
              skills.
            </li>
            <li className="flex items-start mb-3">
            ...
            <li className="flex items-start">
              ✅ Gain confidence in your abilities and take the next step in
              your career as a backend developer.
            </li>
          </ul>
        </div>

        <h2 className="font-mono font-bold mb-2 text-lg lg:text-xl md:text-xl   flex items-center">
          📚 Additional Resources:
        </h2>
        <p className="text-md md:text-lg lg:text-lg leading-7  text-gray-800  ">
          The following resources are recommended to supplement your learning
          and deepen your understanding of digital skills: <br />
          <span className="font-bold text-lg lg:text-xl md:text-xl">
            Books:
          </span>{" "}
          "Cracking the Coding Interview" by Gayle Laakmann McDowell, "Design
          for Hackers" by David Kadavy, "Data Science for Business" by Foster
          Provost and Tom Fawcett. <br />
          <span className="font-bold text-lg lg:text-xl md:text-xl">
            Online Courses:
          </span>{" "}
          Coursera, Udemy, and Codecademy offer a wide range of courses on
          digital skills, data analysis, graphic design, and coding. <br />
          <span className="font-bold text-lg lg:text-xl md:text-xl">
            Blogs and Articles:
          </span>{" "}
          ...
          Join online communities like Stack Overflow, GitHub, and Reddit to
          connect with other developers and designers, ask questions, and share
          your knowledge.
        </p>

        <div className="flex w-full justify-center items-center">
          <button className=" W-15 mt-8 px-8 py-3 text-lg lg:text-xl md:text-xl bg-green-950 font-semibold border-2 border-none p-6 text-white   hover:bg-orange-600  focus:ring-opacity-60 transition duration-300 ">
